...
import 'package:time_slider/Model/Provider%20Classes/pomodoro_timer_provider.dart';
import 'package:time_slider/Model/Provider%20Classes/time_durations_notifier.dart';
...
class PomodoroStates {
  ...
  // static final hourShown = StateProvider((ref) {
  //   final tabIndex = ref.watch(segmentedControlValue);
  //   final timerDuration = ref.watch(timerDurations);
  //   return timerDuration[tabIndex]! > 3599 ? 0.49 : 0.45;
  // });
